...
CloudFlare.define("piwik_analytics", [ "piwik_analytics/config"],function( _config) {
  ...
  // just start appending to the paq_push variable
  // var paq_push="";
  //  paq_push+='var _paq=_paq || []';
  //  paq_push+='_paq.push(["setTrackerUrl",'+ this.config.piwik_reciever + ']);';
  //  paq_push+='_paq.push(["setSiteId",'+ this.config.site_id + ']);';
  //  paq_push+='_paq.push(["enableLinkTracking",'+this.config.link_tracking + ']);';
...
*/
  /*
     ...
     script.innerHTML = this.config.paq_push || paq_push;
