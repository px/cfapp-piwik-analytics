...
task 'minify', 'Minify the resulting application file after build', ->
  ...
  # remove empty lines
  exec 'coffee --bare --lint --print src/coffeescripts/header.coffee | sed -e \'/Generated by CoffeeScript/d\' -e \'/^$/d\' >public/javascripts/piwik_analytics.min.js', (err, stdout, stderr) ->
    throw err if err
    console.log stdout + stderr
  # minify compiled piwik_analytics.js file into the output file
  exec 'jsmin <public/javascripts/piwik_analytics.js  >>public/javascripts/piwik_analytics.min.js', (err, stdout, stderr) ->
    throw err if err
    console.log stdout + stderr
